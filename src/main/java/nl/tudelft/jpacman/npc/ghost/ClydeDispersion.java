 ...
 */
public class ClydeDispersion extends DispersionMove{
    private final Direction [] cycle = {Direction.WEST, Direction.SOUTH, Direction.SOUTH, Direction.WEST,
                                        Direction.WEST, Direction.WEST, Direction.WEST, Direction.SOUTH,
                                        Direction.SOUTH, Direction.EAST, Direction.EAST, Direction.EAST,
    ...
    public ClydeDispersion(Ghost g) {
        super(g);
        setCycle(this.cycle);
